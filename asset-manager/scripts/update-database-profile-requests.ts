...
async function updateDatabase() {
  try {
    console.log("📦 Reading profile update requests schema file...");
    const schemaPath = join(process.cwd(), "database", "profile-update-requests-schema.sql");
    ...
    console.log("🚀 Executing profile update requests schema...\n");

    try {
      // Execute the entire SQL file at once
      await query(schemaSQL);
      
      console.log("✅ Profile update requests schema executed successfully!");
      console.log("\nCreated:");
      console.log("  - profile_update_requests table");
      console.log("  - Row Level Security policies");
      console.log("  - Indexes for performance");
      console.log("\n✅ Database update complete!");
      console.log("The profile update request feature is now available.\n");
    } catch (error: any) {
      ...
      if (
        ...
        console.log("This is normal if you've run the update before.");
        console.log("\n✅ Database update complete!");
        console.log("The profile update request feature is available.\n");
      } else {
